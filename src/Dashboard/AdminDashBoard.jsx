...
const AdminDashBoard = () => {
  ...
  const fetchCustomers = async () => {
    try {
      const response = await fetch('https://inventory-server-1-atx9.onrender.com/inventix/users')
  ...
  const handleSubmit = (e) => {
    ...
    if (modalType === 'add-product') {
      ...
      // Save to database
      fetch('https://inventory-server-1-atx9.onrender.com/inventix/products', {
        method: 'POST',
      ...
      if (selectedItem._id) {
        fetch(`https://inventory-server-1-atx9.onrender.com/inventix/products/${selectedItem._id}`, {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
